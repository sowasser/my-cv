...
%----------------------------------------------------------------------------------------
%
\begin{minipage}[t]{1.00\textwidth} % takes up 100% of the text width of the page
...
\item \textbf{Software \& Coding:} Python, R, NetLogo, Adobe Creative Suite, ArcGIS
\item \textbf{Hardware:} CTD/Sonde, hyperspectral radiometer, multinet, flow cytometer
\end{tightitemize}

\sectionspace % Some whitespace after the section

\end{minipage} % The single column
